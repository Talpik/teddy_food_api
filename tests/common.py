...
def create_reviews(user_client, admin):
    ...
    result.append({
        'id':
        create_review(user_client, titles[0]["id"], 'qwerty', 5),
        'author':
        admin.username,
        'text':
        'qwerty',
    ...
    result.append({
        'id':
        create_review(client_user, titles[0]["id"], 'qwerty123', 3),
        'author':
        user.username,
        'text':
        'qwerty123',
    ...
    result.append({
        'id':
        create_review(client_moderator, titles[0]["id"], 'qwerty321', 4),
        'author':
        moderator.username,
        'text':
        'qwerty321',
...
def create_comments(user_client, admin):
    ...
    result.append({
        'id':
        create_comment(user_client, titles[0]["id"], reviews[0]["id"],
                       'qwerty'),
        'author':
        admin.username,
        'text':
    ...
    result.append({
        'id':
        create_comment(client_user, titles[0]["id"], reviews[0]["id"],
                       'qwerty123'),
        'author':
        user.username,
        'text':
    ...
    result.append({
        'id':
        create_comment(client_moderator, titles[0]["id"], reviews[0]["id"],
                       'qwerty321'),
        'author':
        moderator.username,
        'text':
